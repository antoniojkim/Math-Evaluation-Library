...
//                //        return "The System equals Inconsistent - More Rows than Columns";
//                //      }
//                //      return "The System equals Inconsistent";
//                //      }
...
//    }
    ...
    public static String toStrMatrix(double[] values){
        ...
        for (int i = 0; i<values.length; i++){
            ...
            strMatrix.append(Fraction.toExpression(values[i]).simplify().infix());
        }
        strMatrix.append("}");
        ...
        if (values.length == 1){
            ...
            for (int i = 0; i<values.length; i++){
                ...
                for (int j = 0; j<values[i].length; j++){
                    ...
                    strMatrix.append(Fraction.toExpression(values[i][j]).simplify().infix());
                }
                strMatrix.append("}");
            }
            strMatrix.append("}");
