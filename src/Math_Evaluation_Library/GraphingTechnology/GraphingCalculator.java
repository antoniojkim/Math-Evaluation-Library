...
@author Antonio
*/
public class GraphingCalculator extends Graph{
    
    private static List<Set> sets = new ArrayList<>();
    private static List<Set> drawSets = new ArrayList<>();
    
    public GraphingCalculator(String header) {
        super(header);
    }
    public GraphingCalculator(String header, String[] functions) {
        super(header);
        drawSets.clear();
    ...
    public GraphingCalculator(String header, String function, int xmin, int xmax, int ymin, int ymax) {
