...
//    }
    ...
    public static HashMap<String, MultiParamFunction> createMultiParamMap() {
        ...
        map.put("Bin", new RandomVariable("Bin",     -1, "X ~ Bin(n, p); n trials, probability p; X ~ Binomial Distribution")
            {
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ Binomial(n, p))");
                }
                @Override
                public Expression getVariance(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ Binomial(n, p))");
                }
                @Override
        ...
        map.put("NB",  new RandomVariable("NB",      -1, "NB(k, p); k successes, probability p; X ~ Negative Binomial Distribution")
            {
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ NegativeBinomial(n, p))");
                }
                @Override
                public Expression getVariance(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ NegativeBinomial(n, p))");
                }
                @Override
                public Expression getPDF(Expression[] parameters, Expression xe) {
                    if (parameters.length >= 2){
        ...
        map.put("ND",  new RandomVariable("ND",      -1, "ND(μ, σ²); mean μ, variance σ²; X ~ Normal Distribution")
            {
                ...
                public Expression evaluate(Expression[] parameters) {
                    if (parameters.length == 1){
                        return getPDF(parameters, parameters[0]);
                    }
                    else if (parameters.length == 3){
                        return getPDF(parameters, parameters[2]);
                    }
                    return new MultiParamExpression(this, parameters);
                }
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ NormalDistribution(μ, σ²))");
                }

                @Override
                public Expression getVariance(Expression[] parameters) {
                    if (parameters.length >= 2)    return new NumberExpression(parameters[1].valueOf());
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ NormalDistribution(μ, σ²))");
                }
        ...
        map.put("cdf",  new MultiParamFunction("cdf",   2, "cdf(X, "+x+") calculates P(X≤"+x+") for a random variable X")
        {
            @Override
            public Expression evaluate(Expression[] parameters) {
                if (parameters.length == 2) {
                    if (parameters[0] instanceof MultiParamExpression) {
                        ...
                        if (mpe.getFunction() instanceof RandomVariable) {
                            return ((RandomVariable) mpe.getFunction()).getCDF(mpe.getParameters(), parameters[1]);
                        }
                    }
                }
...
//            });
        ...
        map.put("exprv",  new RandomVariable("exprv",       -1, "exprv(θ); X ~ Exponential Distribution")
            {
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ Exponential(θ))");
                }
                @Override
                public Expression getVariance(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ Exponential(θ))");
                }
                @Override
                public Expression getPDF(Expression[] parameters, Expression xe) {
        ...
        map.put("geo",  new RandomVariable("geo",         -1, "geo(p); X ~ Geometric Distribution")
            {
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ Geometric(p))");
                }
                @Override
                public Expression getVariance(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ Geometric(p))");
                }
                @Override
                public Expression getPDF(Expression[] parameters, Expression xe) {
        ...
        map.put("hyp",  new RandomVariable("hyp",         -1, "hyp(N, r, n); X ~ Hypergeometric Distribution")
            {
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ Hypergeometric(N, r, n))");
                }
                @Override
                public Expression getVariance(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ Hypergeometric(N, r, n))");
                }
                @Override
                public Expression getPDF(Expression[] parameters, Expression xe) {
        ...
        map.put("pdf",  new MultiParamFunction("pdf",   2, "pdf(X, "+x+") calculates P(X="+x+") for a random variable X")
        {
            @Override
            public Expression evaluate(Expression[] parameters) {
                if (parameters.length == 2) {
                    if (parameters[0] instanceof MultiParamExpression) {
                        MultiParamExpression mpe = (MultiParamExpression)parameters[0];
                        if (mpe.getFunction() instanceof RandomVariable) {
                            return ((RandomVariable) mpe.getFunction()).getPDF(mpe.getParameters(), parameters[1]);
                        }
                    }
                }
                return new InvalidExpression("Invalid Argument Error:  cdf expected a random variable as input");
        ...
        map.put("poi",  new RandomVariable("poi",         -1, "poi(λ); X ~ Poisson Distribution")
            {
                ...
                public Expression getExpectedValue(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Exp(X ~ Poisson(λ))");
                }
                @Override
                public Expression getVariance(Expression[] parameters) {
                    ...
                    return new InvalidExpression("Invalid Arguments Error:  Var(X ~ Poisson(λ))");
                }
                @Override
                public Expression getPDF(Expression[] parameters, Expression xe) {
